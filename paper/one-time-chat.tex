...
``Group chat'' (i.e. chat among three or more users) functionality is a trivial extension to two-way secure chat. See Section~\ref{}. % TODO what seciton??
}
...
% NOTE: comments with "<" are TODOs of things to write about.]
% < define terms package and unpackage.
% < context of packaging in system.
% < importance of packaging.
% < warn we wrote our own crypto.
...
%% this is put first to differentiate between the large one-time-pad and the pad_segment
...
% TODO jake, did you talk about metadata somewhere?
...
\label{sec:padgen}
% TODO write
% TODO mention the use of the HPRPNNGNG?
% TODO mention urandom for development but NOT for real life
\begin{figure}[htp]
\centering
